...
/*#__PURE__*/
function (_Model) {
  _inherits(OrdenExamen, _Model);

  function OrdenExamen() {
    _classCallCheck(this, OrdenExamen);

    return _possibleConstructorReturn(this, _getPrototypeOf(OrdenExamen).apply(this, arguments));
  }

  _createClass(OrdenExamen, null, [{
    key: "initModel",
